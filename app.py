...
def display_results(container: ui.column, results_dict: Dict[str, Any], job_title_original: str): 
    ...
    with container:
        ...
        with ui.row().classes('w-full mt-4 gap-4 flex-wrap items-stretch'): # <-- items-stretch pour hauteur égale
...
def main_page(client: Client):
    ...
    with ui.column().classes('w-full max-w-4xl mx-auto p-4 md:p-8 items-center gap-4'):
        ...
        # Le disclaimer est maintenant une phrase unique, courte et placée ici.
        ...
        # Le disclaimer a été déplacé et simplifié.
        # Ce bloc contient uniquement le "Développé par..." et les liens sociaux.
